...
if [ ! -z "$VIM_TERMINAL" ]; then
    set "status-right" "#[fg=$onedark_white,bg=$onedark_visual_grey,nobold] VIMTERM #[fg=$onedark_white, bg=$onedark_visual_grey] $TERM "
else
  set "status-right" "#[fg=$onedark_white,bg=$onedark_visual_grey,nobold] #[fg=$onedark_white, bg=$onedark_visual_grey] $TERM #[fg=$onedark_green, bg=$onedark_visual_grey]%a%l:%M %p #[fg=$onedark_black, bg=$onedark_green,bold] %Y/%m/%d "
fi
set "status-left" "#[fg=$onedark_black,bg=$onedark_green,bold] #h #[fg=$onedark_black,bg=$onedark_blue,bold] #S #{prefix_highlight}"
